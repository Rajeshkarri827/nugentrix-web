...
export const introGridConfig: IntroGridConfig = {
  ...
  portfolioImages: [
    ...
    { src: "/grid-5.jpg", alt: "Talent Assessment" },
  ],
...
export const featuredProjectsConfig: FeaturedProjectsConfig = {
  ...
  projects: [
    ...
    },
    {
      ...
      image: "/project-4.jpg",
      description: "Our staffing practice connects organizations with elite Java developers, DevOps engineers, cloud architects, and full-stack developers. Every candidate goes through phone screening and an initial technical assessment to ensure both skills and cultural fit.",
    },
  ],
};
...
export const servicesConfig: ServicesConfig = {
  ...
  services: [
    ...
    },
    {
      ...
      description: "Connect with elite tech talent for permanent, temporary, or contract positions. Our process includes a thorough phone screening and initial assessment to ensure both technical and cultural fit before presenting candidates to you.",
    },
    {
      iconName: "Cloud",
...
export const faqConfig: FAQConfig = {
  ...
  faqs: [
    ...
    },
    {
      ...
      answer: "Our staffing process begins with understanding your technical requirements and company culture. We then source candidates and conduct a thorough phone screening and initial assessment, evaluating both technical skills and communication. Shortlisted candidates proceed to technical interviews with our own engineers before we present the best fits to you. We offer permanent, temporary, and contract staffing solutions.",
    },
    {
      id: "faq-3",
