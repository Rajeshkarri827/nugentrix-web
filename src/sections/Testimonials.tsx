    ...
    >
      ...
      <div className="container-modern relative z-10">
        ...
        <div ref={sliderRef} className="relative max-w-4xl mx-auto">
          {/* Main Card */}
          <div className="relative bg-white rounded-3xl p-8 lg:p-12" style={{boxShadow:'0 8px 40px rgba(21,101,216,0.1)',border:'1px solid rgba(21,101,216,0.1)'}}>
            {/* Quote Icon */}
            ...
            <div className="absolute bottom-8 right-8 flex gap-2">
              <button 
                onClick={prevSlide}
                className="w-12 h-12 rounded-full hover:bg-blue-50 flex items-center justify-center transition-colors"
              >
